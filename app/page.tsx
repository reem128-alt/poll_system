    ...
    <div className="flex min-h-screen bg-gray-50 overflow-hidden">
      ...
      <div className="w-full md:w-3/4 flex flex-col h-screen overflow-y-scroll custom-scrollbar">
        ...
        <header className="bg-white shadow-sm sticky top-0 z-10">
          <div className="container mx-auto px-3 sm:px-6 py-2 sm:py-4 flex justify-between items-center">
            <div className="flex items-center">
              <h1 className="text-lg sm:text-2xl font-bold text-gray-800 md:hidden">نظام الاستطلاعات</h1>
            </div>
              ...
              {isAuthenticated ? (
                <>
                  <Button 
                    ...
                    className="bg-[#008080] hover:bg-[#006666] text-white text-xs sm:text-sm px-2 py-1 h-8 sm:h-10"
                    size="sm"
                  >
                    <span className="hidden xs:inline">لوحة التحكم</span>
                    <span className="xs:hidden">التحكم</span>
                  </Button>
                  <Button 
                    variant="outline" 
                    className="text-[#008080] border-[#008080] hover:bg-red-50 text-xs sm:text-sm px-2 py-1 h-8 sm:h-10"
                    size="sm"
                    onClick={() => {
